...
def load_data():
    ...
    data_csv['tweet_created'] = pd.to_datetime(data_csv['tweet_created'])
    return data_csv
...
if not st.sidebar.checkbox("Close", True, key='3'):
    ...
    word_cloud = WordCloud(stopwords=STOPWORDS, background_color='white', width=800, height=640).generate(
        processed_words)
