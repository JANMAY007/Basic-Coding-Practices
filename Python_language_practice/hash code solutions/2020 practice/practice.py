...
class Library:
    ...
    def get_best_books_score(self, starting_day=0):
        global book_scores, libraries_signup_days, libraries_max_books_scanned_per_day, D
        available_days = D - self.signup_days - starting_day
...
def sum_book_scores(book_id):
    global book_scores
    return np.sum(np.take(book_scores, list(book_id)))
